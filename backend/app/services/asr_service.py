...
def transcribe(
    audio_path: str, language: str = "ar"
    ...
    try:
        ...
        logger.info(
            f"Transcription complete: {len(transcription)} chars, {len(segments)} segments"
        )
    ...
    try:
        ...
        if _whisperx_model is None:
            ...
            _whisperx_model = whisperx.load_model(
                settings.WHISPER_MODEL_SIZE, device, compute_type=compute_type
            )
